...
automl_run_id = 'mslearn-bike-automl_1'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/eastus/workspaces/6ffa9d05-4b07-44bf-8353-2f97f13a6468/data/alugueldebicicletas/versions/1',     help='Default training dataset uri is populated from the parent run')
